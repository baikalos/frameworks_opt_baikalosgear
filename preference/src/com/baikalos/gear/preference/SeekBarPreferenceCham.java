...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, BaikalOSGEARNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, BaikalOSGEARNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(BaikalOSGEARNS, "interval");
            if(newInterval != null)
